            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group d-flex justify-content-center align-items-center">
                    ...
                    <div className="form-group mb-9">
                        ...
                        <select id='type' name='type' value={formData.type} onChange={handleDropdownChange} className="form-control mb-6">
                    ...
                    <div className="form-group mb-9">
                        ...
                        <select id='age' name='age' value={formData.age} onChange={handleDropdownChange} className="form-control mb-6">
                    ...
                    <div className="form-group mb-9">
                        ...
                        <select id='gender' name='gender' value={formData.gender} onChange={handleDropdownChange} className="form-control mb-6">
